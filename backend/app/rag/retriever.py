...
class KnowledgeRetriever:
    ...
    def _expand_query(self, query: str) -> str:
        aliases = {
            ...
            "市净率": "市净率 price book ratio pb ratio",
            "净资产收益率": "净资产收益率 roe return on equity",
            "净利润": "净利润 net income profit",
            "营业收入": "营业收入 revenue net sales",
            "收入": "收入 revenue",
            "换手率": "换手率 turnover rate",
            "市值": "市值 market capitalization market cap",
            "成交量": "成交量 trading volume",
            "公募基金": "公募基金 mutual fund public fund",
            "ETF": "ETF exchange traded fund 交易型开放式指数基金",
            "债券": "债券 bond yield",
            "期货": "期货 futures margin settlement",
            "期权": "期权 options premium strike",
            "保证金": "保证金 margin collateral",
